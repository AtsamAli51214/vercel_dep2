import {
  ...
  toRefs,
  watch
} from "./chunk-W6QOLW7S.js";
import {
  ApexCharts
} from "./chunk-ZUONJU2S.js";
...
var x = defineComponent({
  ...
  setup(t, { emit: s }) {
    ...
    let h2 = null;
    const b = (e) => {
      h2 || (h2 = { options: false, series: false }, nextTick(() => {
        const o = h2;
        if (h2 = null, !n.value) {
          v();
          return;
...
var ae = defineComponent({
  ...
  setup(t) {
    ...
    return onServerPrefetch(async () => {
      try {
        const { default: r } = await import("./apexcharts.ssr.esm-fe46cd2d-26JAAIXA.js"), n = Object.assign({}, t.options, {
...
var P = defineComponent({
  ...
  setup(t) {
    ...
    onMounted(async () => {
      try {
        const { default: r } = await import("./apexcharts.ssr.esm-fe46cd2d-26JAAIXA.js");

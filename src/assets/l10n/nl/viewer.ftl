...
pdfjs-toggle-views-manager-button-label = Zijbalk schakelen
...
pdfjs-views-manager-pages-status-none-action-label = Selecteer pagina's
...
pdfjs-views-manager-pages-status-waiting-ready-label = Uw bestand wordt voorbereid…
pdfjs-views-manager-pages-status-waiting-uploading-label = Bestand uploaden…
pdfjs-views-manager-status-warning-cut-label = Kon niet knippen. Ververs de pagina en probeer het opnieuw.
pdfjs-views-manager-status-warning-copy-label = Kon niet kopiëren. Ververs de pagina en probeer het opnieuw.
pdfjs-views-manager-status-warning-delete-label = Kon niet verwijderen. Ververs de pagina en probeer het opnieuw.
pdfjs-views-manager-status-warning-save-label = Kon niet opslaan. Ververs de pagina en probeer het opnieuw.
